...
namespace DrugstoreManagementSystem.DataAccess
{
    public class DrugstoreManagementSystemContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Medicine>().Property(x => x.MedicineId)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            modelBuilder.Entity<Supplier>().Property(x => x.SupplierId)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            modelBuilder.Entity<Supply>().Property(x => x.SupplyId)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            modelBuilder.Entity<Sale>().Property(x => x.SaleId)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            modelBuilder.Entity<MedicineSupplyDetail>().Property(x => x.MedicineSupplyDetailId)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            ...
            modelBuilder.Entity<MedicineSaleDetail>().Property(x => x.MedicineSaleDetailId)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
